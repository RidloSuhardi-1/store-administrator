                ...
                @if ($purchases->isNotEmpty())
                    @foreach ($purchases as $purchase)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('purchases.index') }}" class="btn btn-sm btn-primary btn-round btn-icon" data-toggle="tooltip" data-original-title="Klik untuk tinjau detail pembelian">
